...
public class FeedCats {
    ...
    public static void main(String[] args) {
        ...
        Cat[] cat = new Cat[3];
        cat[0] = new Cat("Эрика", 150, 3);
        cat[1] = new Cat("Амелька", 100, 4);
        cat[2] = new Cat("Барсик", 30, 1);
        ...
        System.out.println("Сейчас в миске " + plate.getFood() + " грамм кошачьего корма. Посмотрим насколько его хватит, в данный момент коты очень голодны и направляются трапезничать.\n");
